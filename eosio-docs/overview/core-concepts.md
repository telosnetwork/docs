...
For more information about these concepts, see the [_Accounts and Permissions_](https://github.com/EOSIO/welcome/blob/master/docs/04_protocol/accounts_and_permissions) documentation.
...
For more information about DPOS BFT, see [EOSIO Consensus](https://github.com/EOSIO/welcome/blob/master/docs/04_protocol/01_consensus_protocol.md#3-eosio-consensus-dpos--abft).
