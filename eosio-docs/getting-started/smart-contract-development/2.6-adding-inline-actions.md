...
private:
  ...
  typedef eosio::multi_index<"people"_n, person,
    indexed_by<"byage"_n, const_mem_funuint64_t, &person::get_secondary_1>>
  > address_index;
};
```
...
* [Inline Actions to External Contracts](https://github.com/EOSIO/welcome/blob/master/docs/02_getting-started/03_smart-contract-development/07_inline-action-to-external-contract.md): Learn how to construct actions and send those actions to an external contract.
