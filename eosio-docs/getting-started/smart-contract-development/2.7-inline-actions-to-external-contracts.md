...
private:
  ...
  typedef eosio::multi_index<"people"_n, person, indexed_by<"byage"_n, const_mem_funuint64_t, &person::get_secondary_1>>> address_index;
};
```

## What's Next?

* [Linking Custom Permissions](https://github.com/EOSIO/welcome/blob/master/docs/02_getting-started/03_smart-contract-development/08_linking-custom-permission.md): Learn how create a custom permission and how to link the permission to an action of a contract.
