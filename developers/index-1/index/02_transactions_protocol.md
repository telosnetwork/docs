...
1. Explicit actions, which are present in a signed transaction \(see [2. Transaction Instance](02_transactions_protocol.md#2-transaction-instance)\).
...
| `actions` | array of `action` | list of [action instances](02_transactions_protocol.md#343-action-instance) |
