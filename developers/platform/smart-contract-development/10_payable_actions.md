...
The constructor initializes the hodl\_symbol as “SYS”, which is a token created in the [Deploy, Issue and Transfer Tokens](https://github.com/EOSIO/welcome/blob/master/docs/02\_getting-started/03\_smart-contract-development/02\_deploy-issue-and-transfer-tokens.md#step-5-create-the-token) section.
